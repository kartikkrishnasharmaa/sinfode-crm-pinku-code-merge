                        ...
                        {openMenuId === student.id && (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-green-50 text-green-600 text-sm font-medium transition-colors"
                            >
                              <FaEdit size={14} /> Edit
                            </button>
                            <button
                              ...
                              className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-red-50 text-red-600 text-sm font-medium transition-colors"
                            >
